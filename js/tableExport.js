      ...
      if (defaults.type == 'csv' || defaults.type == 'txt') {
        ...
        $hrows.each(function () {
          ...
          ForEachVisibleCell(this, 'th,td', rowIndex, $hrows.length,
                  function (cell, row, col) {
                    if (cell != null) {
                      $hrows.find('.filterControl').empty();
                      trData += '<td style="';
          ...
          if($('#repTitle').html() != undefined) {
            docData += '<tr><td>' + $('#repTitle').html() + '</td></tr><tr><td></td></tr>';
            rowIndex++;
          }
        ...
        if($('#repFooter').html() != undefined) {
          docData += '<tr><td></td></tr><tr><td>' + $('#repFooter').html() + '</td></tr>';
        }
